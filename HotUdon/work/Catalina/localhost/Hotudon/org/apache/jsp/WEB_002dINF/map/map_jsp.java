 ...
 * Generated at: 2024-03-10 05:48:24 UTC
...
public final class map_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("  <div id=\"search-form\" class=\"input-group mb-3\">\r\n");
      out.write("    <input type=\"text\" id=\"search\" class=\"form-control\" placeholder=\"검색할 주소를 입력하세요\">\r\n");
      out.write("    <div class=\"input-group-append\">\r\n");
      out.write("      <button onclick=\"searchAndMoveTo()\" class=\"btn btn-outline-secondary\">검색</button>\r\n");
      out.write("    </div>\r\n");
      out.write("  </div>\r\n");
      out.write("\r\n");
      out.write("  <div id=\"main-content\">\r\n");
      out.write("    <!-- Map container -->\r\n");
      out.write("    <div id=\"map-container\" class=\"mb-3\">\r\n");
      ...
      out.write("    <input type=\"text\" id=\"basic-address\" class=\"form-control mb-2\" placeholder=\"기본 주소\" readonly>\r\n");
      out.write("    <input type=\"text\" id=\"detail-address\" class=\"form-control mb-2\" placeholder=\"상세 주소\">\r\n");
      out.write("    <!-- '내 중심좌표'와 '주소 저장' 버튼을 왼쪽에 나란히 배치 -->\r\n");
      out.write("    <div id=\"buttons-container\" class=\"d-flex justify-content-start mb-2\">\r\n");
      out.write("      <button id=\"center-map\" onclick=\"panTo()\" class=\"btn btn-info mr-2\">내 중심좌표</button>\r\n");
      out.write("      <button onclick=\"saveAddress()\" class=\"btn btn-primary\">주소 저장</button>\r\n");
      out.write("    </div>\r\n");
      out.write("  </div>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      ...
      out.write("      lat = position.getLat();\r\n");
      out.write("      lon = position.getLng();\r\n");
      out.write("    });\r\n");
      out.write("\r\n");
      ...
      out.write("      var detailAddr = !!result[0].road_address ? '도로명주소 : ' + result[0].road_address.address_name : '';\r\n");
      out.write("      detailAddr += '<br>지번 주소 : ' + result[0].address.address_name;\r\n");
      out.write("\r\n");
      ...
      out.write("          '<div class=\"card custom-infowindow\" style=\"min-width: 22rem; max-width: 25rem;\">' +\r\n");
      out.write("          '<div class=\"card-header bg-primary text-white\">주소 정보</div>' +\r\n");
      out.write("          '<div class=\"card-body\">' +\r\n");
      out.write("          '<h6 class=\"card-subtitle mb-2 text-muted\">현재 위치</h6>' +\r\n");
      out.write("          '<p class=\"card-text no-wrap\">' + detailAddr + '</p>' +\r\n");
      out.write("          '<p class=\"card-text no-wrap\"><small class=\"text-muted\">이 위치는 ' + dong + ' 내에 있습니다.</small></p>' +\r\n");
      out.write("          '</div>' +\r\n");
      out.write("          '</div>';\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("      // 기본 주소 입력 필드 업데이트\r\n");
      out.write("      document.getElementById('basic-address').value = roadAddress ? roadAddress : jibunAddress;\r\n");
      out.write("\r\n");
      ...
      out.write("  }\r\n");
      out.write("\r\n");
      out.write("  // 엔터 키로 주소 검색 활성화\r\n");
      out.write("  document.getElementById('search').addEventListener('keyup', function(event) {\r\n");
      out.write("    if (event.key === \"Enter\") {\r\n");
      out.write("      searchAndMoveTo();\r\n");
      out.write("    }\r\n");
      out.write("  });\r\n");
      out.write("\r\n");
      out.write("  // JSON 파일 URL\r\n");
      out.write("  const jsonFileUrl = './json/TL_SCCO_CTPRVN.json';\r\n");
      out.write("  // jQuery를 사용하여 JSON 파일 로드\r\n");
      out.write("  $.getJSON(jsonFileUrl, function(data) {\r\n");
      out.write("    // 로드된 데이터를 바탕으로 폴리곤 생성\r\n");
      out.write("    data.features.forEach(function(feature) {\r\n");
      out.write("      var coordinates = feature.geometry.coordinates[0];\r\n");
      out.write("      var path = coordinates.map(function(coord) {\r\n");
      out.write("        return new kakao.maps.LatLng(coord[1], coord[0]);\r\n");
      out.write("      });\r\n");
      out.write("\r\n");
